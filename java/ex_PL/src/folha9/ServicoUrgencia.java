...
public class ServicoUrgencia {
    ...
    //• Adicionar um novo atendimento sem permitir a duplicação de identificador (o método
    //deve lançar uma excepção IllegalArgumentException se o identificador fosse duplicado);
    //• Devolver o valor total monetário recebido por todos os atendimentos realizadas no centro
    //de saúde, i.e. a soma das taxas pagas para qualquer tipo de registo de atendimento;
    //• Devolver a média dos graus de prioridade dos atendimentos urgentes (não imediatos).
