...
public class UnidadeCurricular {
    ...
    //d. O método adicionarAluno(…) que recebe um Aluno e adiciona-o ao array. O método deve validar que o número do aluno inserido não é duplicado;
    ...
    //g. O método obterAlunoMelhorMedia() que calcula as médias dos alunos e devolve o aluno com melhor a média. Se existirem alunos com a mesma média, devolver o aluno com o número de cartão mais baixo.
}
